...
uint32_t __si_IndexTable_allocateRowId( SI_IndexTable *, uint8_t * obj);			// 02-05-2025

void __si_IndexTable_putRow( SI_IndexRow *);
void __si_IndexTable_FreeRow( SI_IndexTable * indexTable, uint32_t id);				// 02-05-2025
